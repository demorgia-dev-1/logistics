...
//               gap: { xs: 3, md: 0 }, // smaller gap on desktop
...
//                 p: { xs: 4, md: 5 },
//                 boxShadow: "0 8px 24px rgba(0,0,0,0.12)", // custom shadow
//                 transition: "transform 0.3s ease, box-shadow 0.3s ease",
//                 "&:hover": {
//                   transform: "translateY(-6px)", // lift on hover
//                   boxShadow: "0 12px 28px rgba(0,0,0,0.18)", // stronger hover shadow
//                 },
//                 "&:hover .flipIcon": {
...
//                 sx={{ lineHeight: 1.8 }}
//               >
//                 To be recognized as one of the most reliable and customer-centric
//                 logistics companies, offering end-to-end global solutions by
//                 combining technology, expertise, and personalized service.
//               </Typography>
//             </Paper>
...
//                 sx={{ lineHeight: 1.8 }}
//               >
//                 To empower businesses with seamless logistics solutions 
//                 that reduce complexity, save time, and ensure compliance
//                 — enabling our clients to focus on growth while we take care of their cargo.
//               </Typography>
//             </Paper>
//           </Box>
//         </Box>
...
import VisibilityIcon from "@mui/icons-material/Visibility";
import FlagIcon from "@mui/icons-material/Flag";
import SecurityIcon from "@mui/icons-material/Security"; // Integrity
