...
// /* ================= SLIDER SETTINGS (desktop keep same, mobile -> manual-only swipe) ================= */
...
//   slidesToScroll: 1,
//   autoplay: true, // kept true for desktop/tablet as before (will be overriden per viewport in component)
//   autoplaySpeed: 3000,
//   centerPadding: "0px",
//   arrows: false,
//   pauseOnHover: true,
...
//   responsive: [
//     {
//       breakpoint: 3000, // anything above 1280px
//       settings: {
//         slidesToShow: 3,
//         slidesToScroll: 1,
//       },
...
//         slidesToShow: 1,
//         slidesToScroll: 1,
//         // autoplay will be controlled dynamically in component (disabled on mobile)
//         centerMode: false,
//         centerPadding: "0px",
//         adaptiveHeight: true,
//         variableWidth: false,
...
//   // autoplay control: enabled on widths > 768, disabled on mobile (<= 768)
...
//       setAutoplayEnabled(isDesktop);
//     }

//     window.addEventListener("resize", handleResize);
//     // ensure initial state is correct (in case of SSR/hydration)
//     handleResize();
//     return () => window.removeEventListener("resize", handleResize);
//   }, []);

//   // derive final settings by overriding autoplay based on current viewport
//   const finalSliderSettings = {
//     ...sliderSettings,
//     autoplay: autoplayEnabled,
//     autoplaySpeed: autoplayEnabled ? sliderSettings.autoplaySpeed : 0,
//   };
...
//       {/* Hover Effects + Gap Fix (keeps same visuals on desktop, prevents partial showing on mobile) */}
//       <style>{`
...
//           .services-slider .slick-list { padding: 0 !important; box-sizing: border-box; overflow: hidden; }
//           .services-slider .slick-track { gap: 0 !important; width: 100% !important; box-sizing: border-box !important; }
          
//           /* slick slide itself full width */
//           .services-slider .slick-slide {
//             width: 100% !important;
...
//           /* inner wrapper (card) centered and constrained so it doesn't overflow */
//           .services-slider .slide-card > div {
//             width: 100% !important;
//             max-width: 520px !important; /* control maximum card width on larger phones */
//             box-sizing: border-box !important;
//             margin: 0 auto !important;
//             padding: 0 6px !important;
//           }

//           /* make images fixed height and prevent transform sliding */
...
//           /* lower the overlap so content doesn't get clipped */
...
//           /* badge inline so it doesn't push width */
...
//           /* remove hover transform on mobile (touch) to avoid oversize */
//           .services-slider .slick-slide > div:hover .imageBox { transform: none !important; }
//         }

//         /* Prevent tiny horizontal overflow on very small phones */
//         @media (max-width: 480px) {
//           .services-slider { padding: 0 6px !important; }
//           .services-slider .slick-list { padding: 0 4px !important; }
//           .services-slider .slide-card > div { max-width: 420px !important; } /* smaller phones */
//         }
