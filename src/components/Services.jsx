...
/* ================= SLIDER SETTINGS ================= */
/*
  Desktop: 3 cards (unchanged)
  Tablet (<1024px): 2 cards
  Mobile (<600px): 1 card full width (no peeking)
  Autoplay: 5000ms, swipe enabled, arrows off to preserve desktop look
*/
const sliderSettings = {
  ...
  responsive: [
    ...
    {
      // Mobile: show exactly 1 (no center padding or peek)
      breakpoint: 600,
      settings: {
        slidesToShow: 1,
        slidesToScroll: 1,
...
export default function Services() {
  return (
    <Section id="services">
      ...
      {/* Strong mobile CSS to ensure exact single-card view on phones */}
      <style>{`
